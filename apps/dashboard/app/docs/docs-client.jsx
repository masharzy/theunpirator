  ...
  const upstream = await fetch(
    \`\${process.env.UNPIRATOR_API_URL}/v1/playback/sessions\`,
    {
      ...
      body: JSON.stringify({
        ...
        displayLabel: viewer.email || String(viewer.id),

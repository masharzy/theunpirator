          ...
          <div className="mx-auto max-w-7xl px-5 py-20 md:px-8 md:py-28">
            <div className="grid gap-10 lg:grid-cols-[1.15fr_.85fr] lg:items-end">
              ...
              <p className="max-w-xl text-base leading-7 text-[#667160] sm:text-lg">
                The Unpirator is being built around a simple boundary: your product decides who may watch, and protected playback should respect that decision all the way to delivery.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-7xl px-5 py-20 md:px-8 md:py-24">
          <div className="grid gap-6 lg:grid-cols-[.85fr_1.15fr]">
            <article className="rounded-[32px] bg-[#172014] p-8 text-white sm:p-10">
              ...
              <p className="mt-8 text-xs font-black uppercase tracking-[.18em] text-[#90a875]">What we are building</p>
              ...
              <p className="mt-5 text-sm leading-7 text-[#bac5b5]">
                Developer tooling, a protected player, short-lived sessions, a media gateway and customer controls that fit around an existing product instead of replacing it.
              </p>
              <Link href="/features" className="mt-8 inline-flex items-center gap-2 text-sm font-semibold text-[#dcebbd]">
                Explore the product <ArrowRight size={15} />
              </Link>
            </article>

            <article className="rounded-[32px] border border-[#dce3d5] bg-white p-8 sm:p-10">
              <p className="text-xs font-black uppercase tracking-[.18em] text-[#718054]">Design principles</p>
        ...
        <section className="border-y border-[#dce3d5] bg-white">
          <div className="mx-auto max-w-7xl px-5 py-20 md:px-8 md:py-24">
            <div className="grid gap-8 md:grid-cols-3">
              {[
                ["Customer-owned access", "We do not want your user database. Your backend remains responsible for authentication and entitlement decisions."],
                ["Concrete plan entitlements", "Features such as watermarking, device controls and concurrency rules are enabled by the purchased plan and enforced by backend runtime logic."],
                ["Clear limits", "Protected delivery can reduce casual redistribution and improve accountability, but it cannot make browser video physically impossible to record."],
              ].map(([title, body]) => (

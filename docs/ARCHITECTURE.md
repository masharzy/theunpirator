...
Cloudflare Worker is the **media data plane**: validate playback grants, check fast session state, resolve registered assets through the internal API, proxy byte ranges/HLS objects, rewrite manifests, and emit telemetry.
